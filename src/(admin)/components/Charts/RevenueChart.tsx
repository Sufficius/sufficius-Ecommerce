...
export default function RevenueChart() {
  ...
  const dadosReceita: Record<
    number,
    { meses: string[]; valores: number[]; meta: number[] }
  > = {
    2024: {
      meses: [
        "Jan",
      ...
      valores: [
        85000, 92000, 105000, 98000, 112000, 125000, 132000, 128000, 145000,
        138000, 165000, 210000,
      ],
      meta: [
    ...
    2025: {
      ...
      valores: [
        95000, 105000, 125000, 118000, 135000, 148000, 155000, 162000, 185000,
        195000, 245000, 312000,
      ],
      meta: [
  ...
  const totalReceita = dadosAtuais.valores
  ...
  const crescimentoAnual =
    ano === 2025
      ...
      : "0.0";
  const metaTotal = dadosAtuais.meta
    .slice(0, new Date().getMonth() + 1)
    .reduce((a, b) => a + b, 0);
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <div className="text-2xl font-bold">
            KZ {totalReceita.toLocaleString()}
          </div>
            ...
            <polyline
              ...
              points={dadosAtuais.valores
                ...
                .map((valor, index) => {
                  ...
                  const y =
                    100 - (valor / Math.max(...dadosAtuais.valores)) * 80;
                  return `${x},${y}`;
                })
                .join(" ")}
            />
              ...
              .map((valor, index) => {
                ...
                return (
                  <div
                    ...
                    className="relative"
                    style={{
                      left: `${(index / new Date().getMonth()) * 100}%`,
                    }}
                  >
                    <div
      ...
      <div className="grid grid-cols-3 gap-4 mt-4 pt-4 border-t">
        <div className="text-center">
          ...
          <div className="flex items-center justify-center">
            ...
            <span
              className={`font-bold ${
                Number(crescimentoAnual) > 0 ? "text-green-500" : "text-red-500"
              }`}
            >
              {crescimentoAnual}%
            </span>
        ...
        <div className="text-center">
          ...
          <div className="font-bold">KZ {mediaMensal.toLocaleString()}</div>
        </div>
        <div className="text-center">
